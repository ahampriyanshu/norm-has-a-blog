<script lang="ts">
  ...
  const icons: Record<string, string> = {
    ...
    copy: 'M8 4v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.5L15.5 3H10a2 2 0 0 0-2 2zM15 3v5h5M6 12H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8l4 4v4',
    ...
    'x-twitter': 'M4 4l11.733 16h4.267l-11.733-16zM4 20l6.768-6.768m2.46-2.46L20 4',
    twitter:
